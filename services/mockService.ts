...
export const setFanSpeed = async (speed: number, settings: IloSettings): Promise<boolean> => {
  try {
...
export const setFanSpeedIndex = async (idx: number, speed: number, settings: IloSettings): Promise<boolean> => {
  try {
